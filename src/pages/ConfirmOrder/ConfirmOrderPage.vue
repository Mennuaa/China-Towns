	...
	<div>
		<div class="confirm-order container">
			...
			<div class="confirm-nav">
                <div class="confirm-nav_item">
                    <div class="confirm-nav_item-logo_active">
                        <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.85772 1.74605L7.05743 1.07954C8.26552 0.408381 9.73448 0.408382 10.9426 1.07954L15.9426 3.85732C16.125 3.95868 16.2975 4.0731 16.4591 4.19906L13.0247 6.23112L5.85772 1.74605Z" fill="white"/>
                        <path d="M4.53606 2.4803L2.05743 3.85732C1.80688 3.99652 1.5751 4.16036 1.36444 4.34485C1.36553 4.34546 1.36662 4.34607 1.3677 4.34668L7.34178 7.70719C8.35948 8.27967 9.60606 8.26219 10.6073 7.66142L10.6113 7.65905L11.5713 7.09107L4.85214 2.88626C4.69605 2.78858 4.5883 2.64288 4.53606 2.4803Z" fill="white"/>
                        <path d="M0.45005 5.51061C0.159271 6.07051 0 6.70068 0 7.35395V11.6467C0 13.0994 0.787568 14.4379 2.05743 15.1434L7.05743 17.9211C7.437 18.132 7.84233 18.2766 8.25722 18.355C8.25246 18.3208 8.25 18.2859 8.25 18.2505V9.57498C7.6811 9.49213 7.12352 9.30545 6.60637 9.01455L0.632296 5.65403C0.562639 5.61485 0.501655 5.5662 0.45005 5.51061Z" fill="white"/>
                        <path d="M9.75 9.55424V18.2505C9.75 18.2859 9.74754 18.3208 9.74278 18.355C10.1577 18.2766 10.563 18.132 10.9426 17.9211L15.9426 15.1434C17.2124 14.4379 18 13.0994 18 11.6467V7.35395C18 6.6351 17.8071 5.94422 17.4584 5.34416C17.4343 5.36274 17.4088 5.38007 17.3819 5.39597L11.3791 8.94765L11.377 8.9489C10.8682 9.25381 10.3162 9.45573 9.75 9.55424Z" fill="white"/>
                        </svg>
                    </div>
                    <p class="confirm-nav_item-text_active">Состав заказа</p>
                </div>
                <div class="confirm-nav_item confirm-nav_item-border">
                    <div class="confirm-nav_item-logo">
                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.5 9C11.5 10.3807 10.3807 11.5 9 11.5C7.61929 11.5 6.5 10.3807 6.5 9C6.5 7.61929 7.61929 6.5 9 6.5C10.3807 6.5 11.5 7.61929 11.5 9Z" fill="#EF0000"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M10.4481 19.3019C14.3295 17.1909 17.5544 13.4294 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0.449096 13.4645 3.34219 17.2505 7.52835 19.3518C8.45077 19.8149 9.54146 19.7951 10.4481 19.3019ZM13 9C13 11.2091 11.2091 13 9 13C6.79086 13 5 11.2091 5 9C5 6.79086 6.79086 5 9 5C11.2091 5 13 6.79086 13 9Z" fill="#EF0000"/>
                        </svg>
                    </div>
                ...
                <div class="confirm-nav_item">
                    <div class="confirm-nav_item-logo">
                        ...
                        <path d="M13.9858 3.91224L13.2121 5.85248C12.993 6.40198 13.3977 6.99915 13.9893 6.99915H17.618C18.9407 6.99915 19.8991 8.26016 19.545 9.53458L18.007 15.07C17.526 16.8011 15.9497 17.9992 14.153 17.9992H9.49711C8.76706 17.9992 8.05093 17.7994 7.42633 17.4214L6.17873 16.6665C5.39404 16.1917 4.80938 15.4708 4.49951 14.6363V15.9993C4.49951 16.5516 4.1332 16.9993 3.68133 16.9993H0.817694C0.365824 16.9993 -0.000488281 16.5516 -0.000488281 15.9993V5.99927C-0.000488281 5.44698 0.365824 4.99927 0.817694 4.99927H3.68133C4.1332 4.99927 4.49951 5.44698 4.49951 5.99927V7.56856C4.75622 6.8771 5.20247 6.26107 5.80018 5.79813L6.83177 4.99915L10.621 1.33116C10.8452 1.11413 11.1255 0.963906 11.4304 0.897373C13.1826 0.514973 14.6501 2.24632 13.9858 3.91224Z" fill="#B5B5B5"/>
                        </svg>
                    </div>
                    <p class="confirm-nav_item-text">Состав заказа</p>
                </div>
