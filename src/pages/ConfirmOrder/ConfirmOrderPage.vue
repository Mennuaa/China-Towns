								...
								<div class="place-info__product-btns">
									<ul>
										...
										<li class="default-p_sm ">
											<svg width="13" height="10" viewBox="0 0 13 10"
												...
												<path
													...
													fill="#323232" />
											</svg> 	 <p @click="() => popupDarg = true">Перенести </p> </li>
										<li class="default-p_sm "><svg width="12" height="13" viewBox="0 0 12 13"
											...
											<p @click="() => popupDelete = true">Удалить </p> </li>
									</ul>
								</div>
							</div>
	...
	<div v-if="popupChange" class="popup-overlay">
        ...
        <div class="popup_content">
            ...
            <div class="profile_info_inputs">
                ...
                <MainButton style="margin-top: 20px; width: 100%;" @click="PopupChange()" text="Сохранить изменения">
                </MainButton>
