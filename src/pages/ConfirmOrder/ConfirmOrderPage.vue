	...
	<div>
		<div class="confirm-order container">
			...
			<div class="confirm-nav">
				...
				<div :class="{'active': count === 2 , 'wasActive': count > 2}" class="confirm-nav_item confirm-nav_item-border">
					<div   class="confirm-nav_item-logo">
				...
				<div class="confirm-nav_item">
					<div :class="{'active': count === 3 }" class="confirm-nav_item-logo">
					...
					<div class="confirm-order_grid">
						<div class="confirm-order_back">
							...
							<form class="confirm-order_back_form">
								...
								<input type="text" placeholder="Промокод (при наличии)"
									class="confirm-order_back_input" />
							</form>
						</div>
			...
			<div v-else-if="count == 0" class="first_empty">
				<div class="container">
					<div class="first_empty_content">
						...
						<p class="default-p">Вставьте ссылку с <a href="">alibaba.com</a>, <a href="">taobao.com</a>, <a href="">tmall.com</a> или <a href="">1688.com</a></p>
						<div class="first_empty_last">
							<input type="text" name="" id="" placeholder="Вставьте ссылку на страницу с товаром" class="confirm-order_back_input">
			...
			<div v-else-if="count == 3">
				<div class="confirm-order_three">
					...
					<div class="confirm-order_back">
						...
						<textarea class="confirm-order_textarea" name="" id=""
				...
				<ul class="popup_content-ul">
					...
					<li class="">
						...
						<p class="default-p">При стоимости груза до 30$ \ кг - 2%, стоимость груза 31$ - 100$\кг - 3%,
							...
							<br>
							<br>
							В случае если груз не был застрахован при доставке из Китая в Россию (если при оформлении
							заказа вы не указали что бы мы оформили страховку) то при конфискации на таможне или потере
							груза в пути мы вернем лишь 4$ за 1 кг товара (для авиа доставки ставка к возврату
							составляет 9$ за 1 кг товара) (к примеру если потеряно 100кг * 4$  = 400$ за груз + сумма
							...
							<br>
							<br>
							В случае потери груза при оформленной страховке вам возвращается тот % от суммы который вы
							выбрали при оформлении заказа (к примеру если цена груза составляла 10000 юаней и вы выбрали
				...
				<ul class="popup_content-ul">
					<li class="">
						...
						<p class="default-p">Хотели бы вам объяснить как проходит упаковка посылок для передачи в ТК, мы
							...
							упаковываем ваш товар, если есть пространство мы заполняем его пузырчатой пленкой, и потом
							оборачиваем каждую коробку, не зависимо от размера и габаритов в мешок а затем в  цветной
					...
					<li class="">
						...
						<p class="default-p">
							Эта услуга сокращает плотность груза (вес/объем, как мы знаем чем выше плотность тем ниже
							цена) подходит для тех кто заказывает мягкие объемные вещи: прим. одежда, мягкие игрушки,
