			...
			<div class="orders_content">
				...
				<div class="orders_right">
					<div @click="goBack()" class="profile_mobile_go_back">
						...
						>
							<path
								d="M9.33252 10.6672L6.66585 8.00057L9.33252 5.3339"
					...
					<div class="orders_buttons">
						...
						<div class="order_button">
							<p class="default-p">
								Требуется доставить ваш груз из Китая в Россию?
							</p>
		...
		<div v-if="confirmPopup" class="popup-overlay profile_photo_popup">
			<div class="popup_content">
				<div class="popup_close" @click="showConfirmPopup()">
					...
					>
						<path
							d="M9 23L16 16M16 16L23 9M16 16L23 23M16 16L9 9"
							stroke="var(--primary-text)"
							stroke-linecap="round"
						/>
					</svg>
				...
				<p class="default-p">
					Нажмите «‎Подтвердить заказ» и ваш заказ увидят операторы, приступят к
					его обработке, уточнять стоимость доставки по Китаю. После
					согласования стоимости товара и доставки, будет выставлен счёт на
					оплату в сообщениях к заказу. Уведомление поступит на вашу почту, а
					так же в разделе сообщений. Благодарим за ваш заказ. Нажимая
					«‎Подтвердить заказ» вы соглашаетесь с правилами сайта и подтверждаете
					обработку персональных данных. Запросив счёт у операторов, вы не
					сможете в дальнейшем добавить товары в этот заказ. Если Вы желаете
					добавить ещё товары в заказ, нажмите «‎Позже», а когда будете готовы,
					просто запросите счет в разделе «‎Заказов».
				</p>
